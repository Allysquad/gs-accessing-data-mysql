...
:project_id: gs-accessing-DataObject-mysql
...
`src/main/java/client/User.java`
[source,java]
----
include::complete/src/main/java/client/User.java[]
----
...
`src/main/java/client/UserRepository.java`
[source,java]
----
include::complete/src/main/java/client/UserRepository.java[]
----
...
`src/main/java/client/MainController.java`
[source,java]
----
include::complete/src/main/java/client/MainController.java[]
----
...
`localhost:8080/demo/all` This gets all DataObject
`localhost:8080/demo/add` This adds one user to the DataObject
...
This gives your Spring application only the privileges necessary to make changes to *only* the DataObject of the database and not the structure (schema).
...
* https://spring.io/guides/gs/accessing-DataObject-jpa/[Accessing Data with JPA]
* https://spring.io/guides/gs/accessing-DataObject-mongodb/[Accessing Data with MongoDB]
* https://spring.io/guides/gs/accessing-DataObject-gemfire/[Accessing DataObject with Gemfire]
